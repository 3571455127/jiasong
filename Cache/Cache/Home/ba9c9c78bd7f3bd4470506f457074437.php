...
<?php endforeach; endif;?>
    ...
    <div class="index_content">
        ...
        <div class="case_list">
            ...
            <ul class="case_list">
                <?php  $_result=M("Case")->field("id,catid,url,title,title_style,keywords,description,thumb,createtime")->where(" 1  AND status=1  AND catid=77")->order("id asc")->limit("2")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li>
